CLASS zeal_rap100_gen_data DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zeal_rap100_gen_data IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    ...
    " clear data
    DELETE FROM zeal_rap100_trav.

    " insert travel demo data
    INSERT zeal_rap100_trav FROM (
        SELECT FROM /dmo/travel AS travel
          ...
          UP TO 100 ROWS ).
    COMMIT WORK.
    out->write( |[RAP100] Demo data generated for table zeal_rap100_trav{ group_id }. | ).
  ENDMETHOD.
ENDCLASS.
